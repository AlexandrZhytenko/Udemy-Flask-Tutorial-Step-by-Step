...
# INNER JOIN selects all rows from both participating tables to appear in the result if
# and only if both tables meet the conditions specified in the ON clause